...
public class HearSpectralFilter {
    ...
    final static boolean useRecorder = false;
    final static boolean useProcessor = true;
    final static int NUM_FFTS = 4;
    final static int SIZE_LOG_2 = 10;
    final static int SIZE = 1 << SIZE_LOG_2;
    SpectralProcessor[] processors;
    WhiteNoise noise;
    static final int SAMPLE_RATE = 44100;

    class CustomSpectralProcessor extends SpectralProcessor {
